...
const emptyForm = {
  ...
  data_prevista: "",
  data_escritura: "",
  checklist_vendedor: { certidoes_pessoais: false, certidoes_imovel: false },
  checklist_comprador: { documentacao_completa: false },
...
export default function Escrituras() {
  ...
  function openEdit(item) {
    setForm({
      ...item,
      checklist_vendedor: item.checklist_vendedor || { certidoes_pessoais: false, certidoes_imovel: false },
      checklist_comprador: item.checklist_comprador || { documentacao_completa: false },
    });
          ...
          <div style={modalStyle}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
              ...
              <div style={{ gridColumn: "1 / -1", background: "#F9FAFB", borderRadius: 8, padding: 12 }}>
                <div style={{ fontSize: 13, fontWeight: 700, marginBottom: 8 }}>Checklist — documentação do vendedor</div>
                <label style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 14, marginBottom: 6 }}>
                  <input type="checkbox" checked={form.checklist_vendedor.certidoes_pessoais} onChange={(e) => setForm({ ...form, checklist_vendedor: { ...form.checklist_vendedor, certidoes_pessoais: e.target.checked } })} />
                  Certidões pessoais completas
                </label>
                <label style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 14 }}>
                  <input type="checkbox" checked={form.checklist_vendedor.certidoes_imovel} onChange={(e) => setForm({ ...form, checklist_vendedor: { ...form.checklist_vendedor, certidoes_imovel: e.target.checked } })} />
                  Certidões do imóvel completas
                </label>
              </div>

              <div style={{ gridColumn: "1 / -1", background: "#F9FAFB", borderRadius: 8, padding: 12 }}>
                <div style={{ fontSize: 13, fontWeight: 700, marginBottom: 8 }}>Checklist — documentação do comprador</div>
                <label style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 14 }}>
                  <input type="checkbox" checked={form.checklist_comprador.documentacao_completa} onChange={(e) => setForm({ ...form, checklist_comprador: { ...form.checklist_comprador, documentacao_completa: e.target.checked } })} />
