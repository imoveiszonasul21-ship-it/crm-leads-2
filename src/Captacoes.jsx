...
const emptyForm = { corretor: "", corretor_email: "", endereco: "", tipo_imovel: "", valor: "", status: "buscando", proprietario_nome: "", proprietario_contato: "", observacoes: "" };
              ...
              <div key={item.id} style={{ background: "#fff", borderRadius: 10, border: "1px solid #E5E7EB", padding: "12px 14px", display: "flex", gap: 12, alignItems: "center" }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: 13, color: "#6B7280", marginTop: 2, display: "flex", gap: 12, flexWrap: "wrap" }}>
                    ...
                    {item.proprietario_nome && <span>Prop.: <b style={{ color: "#0F2438" }}>{item.proprietario_nome}</b>{item.proprietario_contato ? ` (${item.proprietario_contato})` : ""}</span>}
        ...
        <div style={overlayStyle}>
          <div style={modalStyle}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
              ...
              <Field label="Nome do proprietário"><input style={inputStyle} value={form.proprietario_nome || ""} onChange={(e) => setForm({ ...form, proprietario_nome: e.target.value })} /></Field>
              <Field label="Contato do proprietário"><input style={inputStyle} value={form.proprietario_contato || ""} onChange={(e) => setForm({ ...form, proprietario_contato: e.target.value })} placeholder="Telefone ou e-mail" /></Field>
              <Field label="Status">
